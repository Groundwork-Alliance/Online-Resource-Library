...
export default function FAQ() {
  ...
  return (
    <div className="container w-75 mt-5 p-5 border border-0">
      <Helmet>
        <title>FAQ</title>
      </Helmet>
      <Accordion className="border border-0">
        <Accordion.Item eventKey="0">
          ...
          <Accordion.Body>
            Alot of those platforms are paid so not eryone can afford them so we
            wanted to create a plaatform which is free to use as well as easy to
            use.
          </Accordion.Body>
        </Accordion.Item>
        ...
        <Accordion.Item eventKey="2">
          ...
          <Accordion.Body>
            you can simply visit the "Tutorials section",and search the video in
            the search bar.
          </Accordion.Body>
        </Accordion.Item>
        ...
        <Accordion.Item eventKey="5">
          ...
          <Accordion.Body style={accordianBody}>
            Yes the source code of this website is in public domain and you can
            get it <a href="https://github.com/suyog3235/ORL">HERE</a>.
          </Accordion.Body>
        </Accordion.Item>
        <Accordion.Item eventKey="6">
          ...
          <Accordion.Body>
            ...
            <a href="https://github.com/suyog3235/ORL">HERE!!</a>so you can
